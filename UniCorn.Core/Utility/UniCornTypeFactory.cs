...
namespace UniCorn.Core
{
    ...
    public static class InstanceFactory<T> where T : class, new()
    {
        ...
        {
            InstanceMethod = UniCornTypeFactory.CreateInstanceDelegate<T>();
        }
    }
    public static class UniCornTypeFactory
    {
        static IMemoryCache memoryCache;
        static UniCornTypeFactory()
        {
        ...
        public static Delegate CreateInstanceDelegate(Type type, Type delegateType)
        {
            ...
            Delegate dynamicMethodDelegate = memoryCache.Get(typeCacheName) as Delegate;
            ...
            if (dynamicMethodDelegate == null)
            {
                ...
                dynamicMethodDelegate = dynamicMethod.CreateDelegate(delegateType);

                memoryCache.Set(typeCacheName, dynamicMethodDelegate, DateTimeOffset.Now.AddHours(2));
            }
        ...
        private static bool EmitPrimitiveOpCode(ILGenerator il, Type type)
        {
